...
st.write(f"Number of Outliers Detected: {len(hdbscan_df1[hdbscan_df1['category'] == 'outlier'])} out of {len(hdbscan_df1)}")
...
st.write(f"Number of Outliers Detected: {len(hdbscan_df2[hdbscan_df2['category'] == 'outlier'])} out of {len(hdbscan_df2)}")
# st.write(hdbscan_df2["cttegory"].unique())
